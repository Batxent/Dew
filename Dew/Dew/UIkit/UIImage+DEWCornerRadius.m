...
#import "UIImage+DEWCornerRadius.h"

@implementation UIImage (DEWCornerRadius)
...
- (void)drawInRect:(CGRect)rect withContentMode:(UIViewContentMode)contentMode clipsToBounds:(BOOL)clips{
    CGRect drawRect = _DEWCGRectFitWithContentMode(rect, self.size, contentMode);
...
CGRect _DEWCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode) {
